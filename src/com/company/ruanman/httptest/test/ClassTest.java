...
//o.testGroupListSuccess();
	...
	public void testRegSuccess() throws Exception {
		...
		PostMethodWebRequest request = new PostMethodWebRequest(
				TestConstants.host + "rest/class/add.json"+user.addParameter_JSESSIONID(), input,
	...
	public void testListSuccess() throws Exception {
		...
		WebRequest request = new GetMethodWebRequest(TestConstants.host
				+ "rest/class/list.json"+user.addParameter_JSESSIONID()+"&groupuuid=4df131a6-042e-4808-b03c-94d99533ea12");
