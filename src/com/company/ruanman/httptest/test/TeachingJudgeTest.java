...
public class TeachingJudgeTest extends AbstractHttpTest {
	...
	public static void main(String args[]) throws Exception {
		...
		TeachingJudgeTest o = new TeachingJudgeTest();
		// o.testRegSuccess();
	//o.testGetSuccess();
//o.testGroupListSuccess();
	...
	public static Test suite() {
		return new TestSuite(TeachingJudgeTest.class);
	}
	...
	public void testListSuccess() throws Exception {
		...
		WebRequest request = new GetMethodWebRequest(TestConstants.host
				+ "rest/teachingjudge/query.json"+user.addParameter_JSESSIONID()
				+"&begDateStr=2015-08-01&endDateStr=2015-08-20&groupuuid=ef3fd53f-03f7-42d6-8258-969a4a980f58");
